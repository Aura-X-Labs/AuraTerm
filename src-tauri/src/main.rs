...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            relay_provider::relay_set_control,
            relay_provider::relay_revoke_all_control,
            relay_provider::relay_resolve_open,
            cloud_bridge::cloud_bridge_set_relay_targets,
            relay_client::relay_list_devices,
            relay_client::relay_connect,
            relay_client::relay_open,
            relay_client::write_relay_input,
            relay_client::relay_request_control,
            relay_client::relay_release_control,
            ...
            bookmark_share::remember_bookmark_subscription,
            bookmark_share::list_bookmark_subscriptions,
            bookmark_share::forget_bookmark_subscription,
            bookmark_share::refresh_bookmark_subscription,
