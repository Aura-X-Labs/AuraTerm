...
- **🔐 凭据加密**: 密码/私钥与元数据分离存储，AES-256-GCM + Argon2id，可选主密码。
- **☁️ 端到端加密云同步**: 免自建后端，将书签/设置/known-hosts 通过 GitHub Gist、Gitee Gist、WebDAV 或 AuraXLab 账户在多设备间同步；上传前以独立同步口令端到端加密，服务端零知识。
